...
class Article extends Admin_Controller {
    ...
    function index()
    {
        ...
        return $this->load->view('admin/_main_layout', $this->data);
    }
    ...
    function create()
    {
        ...
        $this->data['subview'] = 'admin/article/form';
    ...
    function store()
    {
        ...
        dump($data, '$data / Validation unsuccessful');
    ...
    function edit($id = NULL)
    {
        ...
        // set funkcija.
        // TODO: Get article by id and join category and tags
   ...
   function update($id = NULL)
    {
        dump($this->data['categories']);
        // if $id, fetch by $id
        //$this->data['categories'] = $this->category_m->get($id, TRUE);
